...
def main():
    ...
    parser.add_argument("--ff_type", type=str, choices=["swiglu", "squared_relu"], help="Type of feed-forward layer")
    parser.add_argument("--d_ff", type=int, help="Override feed-forward dimension")
